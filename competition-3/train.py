...
def train(dataset_path, model_dir, args):
    ...
    #train_path = os.path.join(dataset_path, 'train_data0.json')
    #val_path = os.path.join(dataset_path, 'train_data0.json')
    train_path = os.path.join(dataset_path, 'train_data4.json')
    val_path = os.path.join(dataset_path, 'valid_data4.json')
